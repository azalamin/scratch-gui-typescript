 ...
 */
const TitledHOC = function (WrappedComponent: any) {
  class TitledComponent extends React.Component<PropsInterface> {
    static defaultProps: { onUpdateProjectTitle: any };
    componentDidMount() {
    ...
    handleReceivedProjectTitle(requestedTitle: any) {
  ...
  interface PropsInterface {
    ...
    onChangedProjectTitle: any;
    onUpdateProjectTitle: any;
    projectTitle: string;
  ...
  const mapDispatchToProps = (dispatch: any) => ({
    onChangedProjectTitle: (title: any) => dispatch(setProjectTitle(title)),
  });
