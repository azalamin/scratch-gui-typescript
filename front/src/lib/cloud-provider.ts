...
class CloudProvider {
   ...
   * cloud data.
   */
  constructor(cloudHost: any, vm: any, username: any, projectId: any) {
    this.vm = vm;
  ...
  onOpen() {
    ...
    this.queuedData.forEach((data: any) => {
  ...
  randomizeDuration(t: any) {
    return Math.random() * t;
  }

  setTimeout(fn: any, time: any) {
    log.info(
   ...
   */
  createVariable(name: any, value: any) {
   ...
   */
  updateVariable(name: any, value: any) {
   ...
   */
  renameVariable(oldName: any, newName: any) {
