 ...
 * @param {STAGE_SIZE_MODES} stageSizeMode - the state of the : STAGE_DISPLAY_SIZESstage size toggle button.
 ...
 */
const resolveStageSize = (stageSizeMode: any, isFullSize: any): any => {
 ...
 * @param {boolean} isFullScreen - true if full-screen mode is: StageDimensions enabled.
 * @return {StageDimensions} - an object describing the dimensions of the stage.
 */
const getStageDimensions = (stageSize: any, isFullScreen: any): any => {
