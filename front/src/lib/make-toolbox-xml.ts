...
const motion = function (isInitialSetup: any, isStage: any, targetId: any) {
...
const xmlEscape = function (unsafe: any) {
...
const events = function (isInitialSetup: any, isStage: any) {
  return `
...
const control = function (isInitialSetup: any, isStage: any) {
  return `
...
const sensing = function (isInitialSetup: any, isStage: any) {
...
const operators = function (isInitialSetup: any) {
...
const makeToolboxXML = function (
  ...
  const moveCategory = (categoryId: any) => {
    const index = categoriesXML.findIndex(
      (categoryInfo: any) => categoryInfo.id === categoryId
    );
    if (index >= 0) {
  ...
  const eventsXML = moveCategory('event') || events(isInitialSetup, isStage);
  const controlXML =
    moveCategory('control') || control(isInitialSetup, isStage);
  const sensingXML =
    moveCategory('sensing') || sensing(isInitialSetup, isStage);
