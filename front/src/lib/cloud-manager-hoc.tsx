 ...
 */
const cloudManagerHOC = function (WrappedComponent: any) {
  class CloudManager extends React.Component<PropsInterface> {
    static defaultProps: {
      cloudHost: any;
      hasCloudPermission: boolean;
      onShowCloudInfo: () => void;
      username: any;
    };
    cloudProvider: any;
    ...
    canUseCloud(props: PropsInterface) {
      return !!(
        props.cloudHost &&
        props.username &&
        props.vm &&
    ...
    shouldConnect(props: PropsInterface) {
      return (
        !this.isConnected() &&
    ...
    shouldDisconnect(props: PropsInterface, prevProps: PropsInterface) {
      return (
    ...
    handleCloudDataUpdate(projectHasCloudData: any) {
