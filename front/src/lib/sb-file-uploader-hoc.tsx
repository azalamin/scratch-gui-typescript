...
// import defaultFile from '../lib/Palm_Tree.sb3';
 ...
 * </SBFileUploaderHOC>
 */
const SBFileUploaderHOC = function (WrappedComponent: any): any {
  class SBFileUploaderComponent extends React.Component<PropsInterface> {
    fileReader: any;
    inputElement: any;
    fileToUpload: any;
    ...
    getProjectTitleFromFilename(fileInputFilename: any) {
  ...
  interface PropsInterface {
    ...
    onSetProjectTitle: any;
    projectChanged: boolean;
    requestProjectUpload: any;
  ...
  const mapStateToProps = (state: any, ownProps: any) => {
    ...
    const loadingState: any = state.scratchGui.projectState.loadingState;
    ownProps.canSave;
    const user =
  ...
  const mapDispatchToProps = (dispatch: any, ownProps: any) => ({
    cancelFileUpload: (loadingState: any) =>
    ...
    onLoadingFinished: (loadingState: any, success: any) => {
    ...
    onSetProjectTitle: (title: any) => dispatch(setProjectTitle(title)),
    ...
    requestProjectUpload: (loadingState: any) =>
