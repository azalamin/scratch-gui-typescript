...
// Custom Thumbnail
import customThumb from './thumbnails/custom-thumbnail.png';
...
export default {
    ...
    // Start of custom THumbnail
    'custom': {
        name: (
            <FormattedMessage
                defaultMessage="Add Custom"
                description="Name for the 'Add custom' how-to"
                id="gui.howtos.custom.name"
            />
        ),
        img: customThumb,
        tags: ['art', 'games', 'stories', 'character'],
        path: 'https://nukkad-web.s3.ap-south-1.amazonaws.com/Cannonball.sb3',
        steps: [
            {
                title: (
                    <FormattedMessage
