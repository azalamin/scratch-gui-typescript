...
const computeRMS = function (samples: any, scaling = 0.55) {
...
const computeChunkedRMS = function (samples: any, chunkSize = 1024) {
 ...
 */
const downsampleIfNeeded = (buffer: any, resampler: any) => {
 ...
 * @returns {SoundBuffer} Downsampled buffer with half the sample rate
 */
const dropEveryOtherSample = (buffer: any) => {
