...
const filterPopupAlerts = (alertsList: any) =>
  alertsList.filter(
    (curAlert: any) =>
...
const filterInlineAlerts = (alertsList: any) =>
  alertsList.filter(
    (curAlert: any) => curAlert.alertType === AlertTypes.INLINE
  );
    ...
    case CLOSE_ALERT: {
      if (action.alertId) {
        action.index = state.alertsList.findIndex(
          (a: any) => a.alertId === action.alertId
        );
    ...
    case CLOSE_ALERTS_WITH_ID: {
      return Object.assign({}, state, {
        alertsList: state.alertsList.filter(
          (curAlert: any) => curAlert.alertId !== action.alertId
        ),
      });
    }
    default:
 ...
 */
const closeAlert = function (index: any): any {
  return {
    type: CLOSE_ALERT,
    index,
  };
 ...
 * @return {object} - an object to be passed to the reducer.
 */
const closeAlertsWithId = function (alertId: any): any {
  return {
 ...
 * @return {object} - an object to be passed to the reducer.
 */
const closeAlertWithId = function (alertId: any): any {
  return {
 ...
 * @return {object} - an object to be passed to the reducer.
 */
const showStandardAlert = function (alertId: any): any {
  return {
    type: SHOW_ALERT,
    alertId,
  };
 ...
 * @return {object} - an object to be passed to the reducer.
 */
const showExtensionAlert = function (data: any): any {
  return {
 ...
 */
const showAlertWithTimeout = function (dispatch: any, alertId: any): any {
  const alertData = alertsData.find(
    (thisAlertData: any) => thisAlertData.alertId === alertId
  );
  if (alertData) {
