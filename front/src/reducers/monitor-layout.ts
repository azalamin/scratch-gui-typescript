...
const _verifyRect = function (upperStart: any, lowerEnd: any) {
  if (
    isNaN(upperStart.x) ||
    isNaN(upperStart.y) ||
    isNaN(lowerEnd.x) ||
...
const _addMonitorRect = function (state: any, action: any) {
...
const _moveMonitorRect = function (state: any, action: any) {
  if (!state.monitors.hasOwnProperty(action.monitorId)) {
    log.error(
...
const _resizeMonitorRect = function (state: any, action: any) {
  if (!state.monitors.hasOwnProperty(action.monitorId)) {
    log.error(
...
const _removeMonitorRect = function (state: any, action: any) {
  if (!state.monitors.hasOwnProperty(action.monitorId)) {
    log.error(
...
const _rectsIntersect = function (rect1: any, rect2: any) {
 ...
 */
const moveMonitorRect = function (monitorId: any, newX: any, newY: any): any {
  return {
 ...
 */
const resizeMonitorRect = function (
  monitorId: any,
  newWidth: any,
  newHeight: any
): any {
 ...
 */
const removeMonitorRect = function (monitorId: any): any {
  return {
