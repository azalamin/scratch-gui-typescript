...
const DONE_FETCHING_WITH_PATH = 'scratch-gui/project-state/DONE_FETCHING_WITH_PATH';
...
const DONE_LOADING_VM_WITH_PATH = 'scratch-gui/project-state/DONE_LOADING_VM_WITH_PATH';
...
const getIsLoadingWithPath = loadingState => (
...
const getIsShowingWithPath = loadingState => (
    loadingState === LoadingState.SHOWING_WITH_PATH
);
    ...
    switch (action.type) {
        ...
        case START_LOADING_VM_PATH_UPLOAD:
            if (
                [
                    LoadingState.NOT_LOADED,
                    LoadingState.SHOWING_WITH_PATH,
                ].includes(state.loadingState)
            ) {
                return Object.assign({}, state, {
                    loadingState: LoadingState.LOADING_VM_PATH_UPLOAD,
...
const onLoadedProject = (loadingState, canSave, success) => {
    ...
    case LoadingState.LOADING_VM_WITH_PATH:
        console.log(success); //! New Line Added
        if (success) {
