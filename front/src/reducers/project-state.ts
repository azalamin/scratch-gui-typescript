...
const DONE_FETCHING_WITH_PATH =
  'scratch-gui/project-state/DONE_FETCHING_WITH_PATH';
...
const DONE_LOADING_VM_WITH_PATH =
  'scratch-gui/project-state/DONE_LOADING_VM_WITH_PATH';
...
const START_LOADING_VM_PATH_UPLOAD =
  'scratch-gui/project-state/START_LOADING_VM_PATH_UPLOAD';
...
const LoadingState = keyMirror({
  ...
  FETCHING_WITH_PATH: null,
  LOADING_VM_FILE_UPLOAD: null,
  LOADING_VM_NEW_DEFAULT: null,
  LOADING_VM_WITH_ID: null,
  LOADING_VM_WITH_PATH: null,
  MANUAL_UPDATING: null,
  REMIXING: null,
  SHOWING_WITH_ID: null,
  SHOWING_WITH_PATH: null,
  SHOWING_WITHOUT_ID: null,
  UPDATING_BEFORE_COPY: null,
  UPDATING_BEFORE_NEW: null,
  LOADING_VM_PATH_UPLOAD: null,
});

const LoadingStates = Object.keys(LoadingState);

const getIsFetchingWithoutId = (loadingState: any) =>
  // LOADING_VM_FILE_UPLOAD is an honorary fetch, since there is no fetching step for file uploads
  loadingState === LoadingState.LOADING_VM_FILE_UPLOAD ||
  loadingState === LoadingState.FETCHING_NEW_DEFAULT;
const getIsFetchingWithId = (loadingState: any) =>
  loadingState === LoadingState.FETCHING_WITH_ID ||
  loadingState === LoadingState.FETCHING_NEW_DEFAULT;
const getIsLoadingWithId = (loadingState: any) =>
  loadingState === LoadingState.LOADING_VM_WITH_ID ||
  loadingState === LoadingState.LOADING_VM_NEW_DEFAULT;
const getIsLoadingWithPath = (loadingState: any) =>
  loadingState === LoadingState.LOADING_VM_WITH_PATH ||
  loadingState === LoadingState.LOADING_VM_NEW_DEFAULT;
const getIsLoading = (loadingState: any) =>
  loadingState === LoadingState.LOADING_VM_FILE_UPLOAD ||
  loadingState === LoadingState.LOADING_VM_PATH_UPLOAD ||
  loadingState === LoadingState.LOADING_VM_WITH_ID ||
  loadingState === LoadingState.LOADING_VM_WITH_PATH ||
  loadingState === LoadingState.LOADING_VM_NEW_DEFAULT;
const getIsLoadingUpload = (loadingState: any) =>
  loadingState === LoadingState.LOADING_VM_FILE_UPLOAD ||
  loadingState === LoadingState.LOADING_VM_PATH_UPLOAD;
const getIsCreatingNew = (loadingState: any) =>
  loadingState === LoadingState.CREATING_NEW;
const getIsAnyCreatingNewState = (loadingState: any) =>
  loadingState === LoadingState.FETCHING_NEW_DEFAULT ||
  loadingState === LoadingState.LOADING_VM_NEW_DEFAULT ||
  loadingState === LoadingState.CREATING_NEW;
const getIsCreatingCopy = (loadingState: any) =>
  loadingState === LoadingState.CREATING_COPY;
const getIsManualUpdating = (loadingState: any) =>
  loadingState === LoadingState.MANUAL_UPDATING;
const getIsRemixing = (loadingState: any) =>
  loadingState === LoadingState.REMIXING;
const getIsUpdating = (loadingState: any) =>
...
const getIsShowingProject = (loadingState: any) =>
  loadingState === LoadingState.SHOWING_WITH_ID ||
  loadingState === LoadingState.SHOWING_WITH_PATH ||
  loadingState === LoadingState.SHOWING_WITHOUT_ID;
const getIsShowingWithId = (loadingState: any) =>
  loadingState === LoadingState.SHOWING_WITH_ID;
const getIsShowingWithPath = (loadingState: any) =>
  loadingState === LoadingState.SHOWING_WITH_PATH;
const getIsShowingWithoutId = (loadingState: any) =>
  loadingState === LoadingState.SHOWING_WITHOUT_ID;
const getIsError = (loadingState: any) => loadingState === LoadingState.ERROR;
...
const reducer = function (state: any, action: any) {
  ...
  switch (action.type) {
    ...
    case DONE_FETCHING_WITH_ID:
      ...
      return state;
    case DONE_FETCHING_WITH_PATH:
      if (state.loadingState === LoadingState.FETCHING_WITH_PATH) {
        return Object.assign({}, state, {
          loadingState: LoadingState.LOADING_VM_WITH_PATH,
          projectData: action.projectData,
        });
    ...
    case DONE_LOADING_VM_WITH_ID:
      ...
      return state;
    case DONE_LOADING_VM_WITH_PATH:
      console.log(action);
      if (state.loadingState === LoadingState.LOADING_VM_WITH_PATH) {
        return Object.assign({}, state, {
          loadingState: LoadingState.SHOWING_WITH_PATH,
        });
      }
    ...
    case START_LOADING_VM_FILE_UPLOAD:
      ...
      return state;
    case START_LOADING_VM_PATH_UPLOAD:
      if (
        [LoadingState.NOT_LOADED, LoadingState.SHOWING_WITH_PATH].includes(
          state.loadingState
        )
      ) {
        return Object.assign({}, state, {
...
const doneCreatingProject = (id: any, loadingState: any) => {
  switch (loadingState) {
...
const onFetchedProjectData = (projectData: any, loadingState: any) => {
  switch (loadingState) {
    ...
    case LoadingState.FETCHING_WITH_PATH:
      return {
        type: DONE_FETCHING_WITH_PATH,
        projectData: projectData,
      };
...
const onLoadedProject = (loadingState: any, canSave: any, success: any) => {
  switch (loadingState) {
    ...
    case LoadingState.LOADING_VM_WITH_PATH:
      if (success) {
        return { type: DONE_LOADING_VM_WITH_PATH };
      }
      // failed to load project; just keep showing current project
      return { type: RETURN_TO_SHOWING };
...
const doneUpdatingProject = (loadingState: any) => {
  switch (loadingState) {
...
const requestProjectUpload = (loadingState: any) => {
  switch (loadingState) {
    ...
    case LoadingState.SHOWING_WITH_PATH:
      return {
        type: START_LOADING_VM_PATH_UPLOAD,
      };
    default:
      break;
  }
