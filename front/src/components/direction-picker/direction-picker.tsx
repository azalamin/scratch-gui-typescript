...
const DirectionPicker = (props: PropsInterface) => {
	function callFormatMessage(id: FormattedMessage.MessageDescriptor) {
		return props.intl.formatMessage({ id: id }, '', '', '', '')?.message;
	}
	return (
					...
					<div>
						...
						<div className={styles.buttonRow}>
							<button
								...
								title={callFormatMessage(messages.allAround)}
							...
							<button
								...
								title={callFormatMessage(messages.leftRight)}
							...
							<button
								...
								title={callFormatMessage(messages.dontRotate)}
