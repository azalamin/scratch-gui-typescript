...
const TelemetryModal = (props) => {
    const [settingWasUpdatedTimer, setSettingWasUpdatedTimer] = useState(null);
    ...
    const handleSettingWasUpdatedTimeout = (thisTimer) => {
