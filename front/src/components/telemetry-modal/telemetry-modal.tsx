...
const TelemetryModal = (props: PropsInterface) => {
	const [settingWasUpdatedTimer, setSettingWasUpdatedTimer] = useState<any>(null);
			...
			<div dir={props.isRtl ? 'rtl' : 'ltr'}>
				...
				<Box className={styles.body}>
					...
					<Box className={styles.radioButtons}>
						<label className={isOn ? styles.labelSelected : undefined}>
							<input
								name='optInOut'
								type='radio'
								value='true'
						...
						<label className={isOff ? styles.labelSelected : undefined}>
							<input
								name='optInOut'
								type='radio'
								value='false'
					...
					<Box className={styles.buttonRow}>
						...
						<button className={styles.optIn} onClick={props.onRequestClose} disabled={isUndecided}>
