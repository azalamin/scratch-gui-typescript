...
let isRendererSupported: any = null;

const GUIComponent = (props: PropsInterface) => {
	const {
		accountNavOpen,
		activeTabIndex,
		alertsVisible,
									...
									>
										<TabList className={tabClassNames.tabList}>
											<Tab className={tabClassNames.tab}>
												<img draggable={false} src={codeIcon} alt='' />
												<FormattedMessage
													defaultMessage='Code'
											...
											<Tab className={tabClassNames.tab} onClick={onActivateCostumesTab}>
												<img draggable={false} src={costumesIcon} alt='' />
												{targetIsStage ? (
													<FormattedMessage
											...
											<Tab className={tabClassNames.tab} onClick={onActivateSoundsTab}>
												<img draggable={false} src={soundsIcon} alt='' />
												<FormattedMessage
										...
										<TabPanel className={tabClassNames.tabPanel}>
											...
											<Box className={styles.extensionButtonContainer}>
												<button
													...
													title={intl.formatMessage(messages.addExtension, '', '', '', '')?.message}
...
interface PropsInterface {
	...
	onActivateTab?: any;
	onClickAccountNav?: any;
	onClickLogo?: any;
	onCloseAccountNav?: any;
	onExtensionButtonClick?: any;
	onLogOut?: any;
	onOpenRegistration?: any;
	onRequestCloseBackdropLibrary?: any;
	onRequestCloseCostumeLibrary?: any;
	onRequestCloseTelemetryModal?: any;
	onSeeCommunity?: any;
	onShare?: any;
	onShowPrivacyPolicy?: any;
	onStartSelectingFileUpload?: any;
	onTabSelect?: any;
	onTelemetryModalCancel?: any;
	onTelemetryModalOptIn?: any;
	onTelemetryModalOptOut?: any;
	...
	vm?: any;
	alertsVisible?: any;
	connectionModalVisible?: any;
	isTelemetryEnabled?: any;
